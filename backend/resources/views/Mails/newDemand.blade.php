                      ...
                      ">
                        ...
                        ">
                                ...
                                " align="left">
                                        ...
                                        padding-left: 0px;
                                      " align="center">
                                                                        <img align="center" border="0" src="{{asset('/storage/images/logo_ista-removebg-preview.png')}}" alt="image" title="image" style="
                                          outline: none;
                                ...
                                " align="left">
                                                            ...
                                                            <h1 class="v-text-align v-font-size" style="
                                    margin: 0px;
                                    line-height: 140%;
                                    text-align: center;
                                    word-wrap: break-word;
                      ...
                      ">
                        ...
                        ">
                                ...
                                " align="left">
                                  ...
                                  font-family: 'Raleway', sans-serif;
                                " align="left">
                                                            <table height="0px" align="left" border="0" cellpadding="0" cellspacing="0" width="38%" style="
                                    border-collapse: collapse;
                                    table-layout: fixed;
                                    border-spacing: 0;
                                    mso-table-lspace: 0pt;
                                  ...
                                  font-family: 'Raleway', sans-serif;
                                " align="left">
                                                            <div class="v-text-align v-font-size" style="
                                    font-size: 14px;
                                    line-height: 140%;
                                    text-align: justify;
                                    word-wrap: break-word;
                                  ">
                                                                ...
                                                                <p style="line-height: 140%"> </p>
                                                                <p style="line-height: 140%">
                                                                    Je voudrais un document : <b>{{$type}}</b>
                                                                </p>
                                                                <p style="line-height: 140%"> </p>
                                                                <p style="line-height: 140%">
                                                                    Je vous remercie à l’avance de votre aide dans cette demande. En attendant votre réponse, je demeure à votre disposition pour tout renseignement complémentaire.
                                                                </p>
                                                                <p style="line-height: 140%"> </p>
                                                                <p style="line-height: 140%">
                                                                ...
                                                                <p style="line-height: 140%"> </p>
                                                                <p style="line-height: 140%">Sincèrement,</p>
                                                                <p style="line-height: 140%">
                                                                    [{{$user->last_name}}, {{$user->first_name}}]
                                                                    <br>
                                                                    Groupe : <b>"{{$user->classe}}"</b>
                                                                </p>
                                                            </div>
                                                        </td>
                                                    </tr>
