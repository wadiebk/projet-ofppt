                        ...
                        ">
                                ...
                                " align="left">
                                  ...
                                  ">
                                                                ...
                                                                <p style="line-height: 140%">
                                                                @if($state)
                                                                    Votre demande de document {{$damand->type}} a été acceptée
                                                                @else
                                                                    Votre demande de document {{$damand->type}} a non acceptée
                                                                @endif
                                                            </p>
                                                            <p style="line-height: 140%"> </p>
                                                            <p style="line-height: 140%">
                                                                @if($state)
                                                                    Rendez-vous à l’administration le : {{$damand->when_to_deliver}}
                                                                @endif
                                                                <p style="line-height: 140%"> </p>
                                                                <p style="line-height: 140%">
